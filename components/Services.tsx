...
const Services = () => {
    return (
        <div id='services' className='flex flex-col w-full h-full px-20 py-12 mt-20 relative'>
            <h2 className='text__gradient text-5xl font-bold'>Servicios</h2>
            <div className='flex mt-16 content-center items-center justify-around'>
                <div className='card__custom relative w-80 h-80 bg-bg-300 border-2 shadow-lg shadow-primary-300/70 border-primary-300 rounded-3xl items-center flex justify-center content-center'>
            ...
            <div className='flex b__gradient border-3 border-bg-100 flex-col absolute rounded-full translate-x-36 translate-y-96 py-8 px-12 justify-center content-center items-start mt-40 w-9/12'>
