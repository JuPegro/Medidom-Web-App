...
const Navbar = () => {
    return (
        <header className='w-full'>
            <nav className='flex justify-between content-center top-0 sticky items-center bg-transparent'>
                <div className='flex content-center py-5 px-20 gap-3 '>
                ...
                <div className='custom__hover flex pr-20 text-lg'>
                    <a className='relative mr-12 font-normal hover:text-primary-100' href="#home">Inicio</a>
